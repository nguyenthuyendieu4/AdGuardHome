...
var blockedServices = []blockedService{{
	...
	ID:      "zalo",
	Name:    "Zalo",
	IconSVG: []byte("<svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"currentColor\" viewBox=\"0 0 24 24\"><path d=\"M4 5.5A3.5 3.5 0 0 1 7.5 2h9A3.5 3.5 0 0 1 20 5.5v9a3.5 3.5 0 0 1-3.5 3.5h-5l-3.8 3a.8.8 0 0 1-1.2-.63V18A3.5 3.5 0 0 1 4 14.5zm3.1 1.3a.75.75 0 1 0 0 1.5h7.92L6.57 16.2a.75.75 0 0 0 1.06 1.06l8.45-7.93v.07a.75.75 0 0 0 1.5 0V7.55a.75.75 0 0 0-.75-.75z\"/></svg>"),
	Rules: []string{
		"||cscfdl.com^",
		"||cscpdl.com^",
		"||dlfl.me^",
